  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6">
      ...
      <div className="text-center mb-6 md:mb-8">
        ...
        <p className="text-green-600 text-sm md:text-base">Your financial overview</p>
      </div>

      {/* Stats Section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 md:mb-8">
        <div className="bg-[oklch(0.627_0.194_149.214)] p-4 md:p-6 rounded-lg shadow-md text-center">
          <h2 className="text-lg md:text-xl font-semibold text-black">Total Income</h2>
          <p className="text-xl md:text-2xl text-white">${totalIncome.toFixed(2)}</p>
        </div>
        <div className="bg-[oklch(0.627_0.194_149.214)] p-4 md:p-6 rounded-lg shadow-md text-center">
          <h2 className="text-lg md:text-xl font-semibold text-black">Total Expenses</h2>
          <p className="text-xl md:text-2xl text-white">${totalExpenses.toFixed(2)}</p>
        </div>
        <div className="bg-[oklch(0.627_0.194_149.214)] p-4 md:p-6 rounded-lg shadow-md text-center">
          <h2 className="text-lg md:text-xl font-semibold text-black">Total Savings</h2>
          <p className="text-xl md:text-2xl text-white">${totalSavings.toFixed(2)}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6 md:mb-8">
        <div className="bg-white p-4 md:p-6 rounded-lg shadow-md">
          <h3 className="text-lg md:text-xl font-semibold mb-4 text-black">Income vs Expenses</h3>
          <Pie data={pieChartData} />
        </div>
        <div className="bg-white p-4 md:p-6 rounded-lg shadow-md text-black">
          <h3 className="text-lg md:text-xl font-semibold mb-4">Savings Over Time</h3>
          <Line data={lineChartData} />
        </div>
      </div>

      {/* Budget Goal Section */}
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-md mb-6 md:mb-8 text-black">
        <h3 className="text-lg md:text-xl font-semibold mb-4">Set Your Budget Goal</h3>
      ...
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-md mb-6 md:mb-8 text-black">
        ...
        <table className="w-full" style={{ borderSpacing: "10px", borderCollapse: "separate" }}>
          <thead>
      ...
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-md text-black">
        <h3 className="text-lg md:text-xl font-semibold mb-4">Add New Transaction</h3>
        <div className="flex flex-col md:flex-row gap-4">
          <input
            type="text"
